...
export const ProPlayersLongest = ({ users }) => {
	const [firstPro, setFirstPro] = useState({ first_name: "", last_name: "", longest: "", imageLink: "" });
	const [secondPro, setSecondPro] = useState({ first_name: "", last_name: "", longest: "", imageLink: "" });
	const [thirdPro, setThirdPro] = useState({ first_name: "", last_name: "", longest: "", imageLink: "" });
				...
				<Grid container sx={{ minHeight: '24vh', borderBottom: '1px solid #d1d1d1' }}>
					...
					<Grid xs={6} item>
						{firstPro.longest && (<>
							...
							<Typography sx={scoreBoxName} variant="h5" component="h5">{firstPro.longest}  {firstPro.longest == 1 ? " yd" : " yds"} </Typography>
						</>)}
					</Grid>
				</Grid>
			</Grid>
				...
				<Grid container sx={{ minHeight: '24vh', borderBottom: '1px solid #d1d1d1' }}>
					...
					<Grid xs={6} item>
						{secondPro.longest && (<>
							...
							<Typography sx={scoreBoxName} variant="h5" component="h5">{secondPro.longest} {secondPro.longest == 1 ? " yd" : " yds"}  </Typography>
						</>)}
				...
				<Grid container sx={{ minHeight: '24vh' }}>
					...
					<Grid xs={6} item>
						{thirdPro.longest && (<>
							...
							<Typography sx={scoreBoxName} variant="h5" component="h5">{thirdPro.longest} {thirdPro.longest == 1 ? " yd" : " yds"}  </Typography>
						</>)}
					</Grid>
				</Grid>
			</Grid>
